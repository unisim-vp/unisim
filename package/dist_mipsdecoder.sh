...
import unisim/util/forbint || exit
...
AC_INIT([UNISIM MIPSDecoder MIPSv7 decoder plugin for formal debugger], [${SIMULATOR_VERSION}], [Yves Lhuillier <yves.lhuillier@cea.fr>], [unisim-${SIMPKG}-core])
