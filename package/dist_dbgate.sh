...
UNISIM_TESTBENCH_SOURCE_FILES="\
test.cc
"

UNISIM_TESTBENCH_HEADER_FILES="\
"

UNISIM_TESTBENCH_DATA_FILES="\
COPYING \
NEWS \
ChangeLog \
AUTHORS \
...
UNISIM_TESTBENCH_FILES="\
${UNISIM_TESTBENCH_SOURCE_FILES} \
${UNISIM_TESTBENCH_HEADER_FILES} \
${UNISIM_TESTBENCH_DATA_FILES} \
"

for file in ${UNISIM_TESTBENCH_FILES}; do
...
unisim_${SIMPKG}_${AM_SIMULATOR_VERSION}_SOURCES = ${UNISIM_TESTBENCH_SOURCE_FILES}
...
noinst_HEADERS = ${UNISIM_LIB_PLUGIN_HEADER_FILES} ${UNISIM_TESTBENCH_HEADER_FILES} dbgate.gdb dbgate.py
