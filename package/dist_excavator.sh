#!/bin/bash
SIMPKG=excavator
SIMPKG_SRCDIR=cxx/excavator
source "$(dirname $0)/dist_common.sh"

import unisim/util/loader/elf_loader || exit
import unisim/util/json || exit
...
AC_INIT([UNISIM Excavator], [${SIMULATOR_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>], [unisim-${SIMPKG}])
