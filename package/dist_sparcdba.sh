...
UNISIM_SIMULATOR_TOP_ISA="sparc.isa"
...
AC_INIT([UNISIM sparcdba Sparcv8 to BINSEC-DBA translator], [${SIMULATOR_VERSION}], [Yves Lhuillier <yves.lhuillier@cea.fr>], [unisim-${SIMPKG}-core])
...
BUILT_SOURCES=\
	\$(top_builddir)/sparc.hh\
	\$(top_builddir)/sparc.tcc
