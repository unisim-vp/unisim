...
AC_INIT([UNISIM TMS320C3X Standalone simulator], [${SIMULATOR_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>, Daniel Gracia Perez <daniel.gracia-perez@cea.fr>], [unisim-${SIMPKG}])
...
\$(top_builddir)/unisim/component/cxx/processor/tms320c3x/isa_tms320c3x.hh: ${UNISIM_LIB_SIMULATOR_ISA_FILES}
	\$(PYTHON_BIN) \$(top_srcdir)/genisslib.py -o \$(top_builddir)/unisim/component/cxx/processor/tms320c3x/isa_tms320c3x -w 32 -I \$(top_srcdir)/unisim/component/cxx/processor/tms320c3x/isa \$(top_srcdir)/unisim/component/cxx/processor/tms320c3x/isa/tms320c3x.isa
EOF
)
