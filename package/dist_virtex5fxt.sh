...
AC_INIT([UNISIM Virtex 5 FXT Standalone simulator], [${SIMULATOR_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>, Daniel Gracia Perez <daniel.gracia-perez@cea.fr>, Reda Nouacer <reda.nouacer@cea.fr>], [unisim-${SIMPKG}])
...
\$(top_builddir)/unisim/component/cxx/processor/powerpc/book_e/ppc440/isa/ppc440.hh: ${UNISIM_LIB_SIMULATOR_ISA_FILES}
	\$(PYTHON_BIN) \$(top_srcdir)/genisslib.py -o \$(top_builddir)/unisim/component/cxx/processor/powerpc/book_e/ppc440/isa/ppc440 -w 8 -I \$(top_srcdir) \$(top_srcdir)/unisim/component/cxx/processor/powerpc/book_e/ppc440/isa/ppc440.isa
EOF
)
