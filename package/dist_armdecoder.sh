...
This package contains:
  - Armdecoder: an ARMv7 decoder for BINSEC::DBA translation
...
AC_INIT([UNISIM Armdecoder ARMv7 to BINSEC-DBA translator package], [${SIMULATOR_VERSION}], [Yves Lhuillier <yves.lhuillier@cea.fr>], [unisim-${SIMPKG}])
