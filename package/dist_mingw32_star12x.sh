...
UNISIM_SIMULATORS_HCS12X_TESTBENCH_FILES="default_config.xml ATD.xml ATD.xls pwm.xls"
...
UNISIM_LIB_HCS12X_FILES="${UNISIM_LIB_HCS12X_SOURCE_FILES} ${UNISIM_LIB_HCS12X_HEADER_FILES} ${UNISIM_LIB_HCS12X_TEMPLATE_FILES}  ${UNISIM_LIB_HCS12X_DATA_FILES}"
...
UNISIM_SIMULATORS_HCS12X_FILES="${UNISIM_SIMULATORS_HCS12X_SOURCE_FILES} ${UNISIM_SIMULATORS_HCS12X_HEADER_FILES} ${UNISIM_SIMULATORS_HCS12X_TEMPLATE_FILES} ${UNISIM_SIMULATORS_HCS12X_DATA_FILES} ${UNISIM_SIMULATORS_HCS12X_TESTBENCH_FILES}"
