...
unisim/component/cxx/processor/risc16/cpu.hh \
unisim/component/tlm2/memory/ram/memory.hh \
unisim/component/tlm2/processor/risc16/cpu.hh \
"
...
if [ "${has_to_build_configure}" = "yes" ]; then
	...
	echo "AC_INIT([UNISIM risc16 Standalone simulator], [${RISC16_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>, Réda Nouacer <reda.nouacer@cea.fr>], [unisim-risc16])" > "${DEST_DIR}/configure.ac"
...
if [ "${has_to_build_risc16_configure}" = "yes" ]; then
	...
	echo "AC_INIT([UNISIM risc16 C++ simulator], [${RISC16_VERSION}], [Gilles Mouchard <gilles.mouchard@cea.fr>, Réda Nouacer <reda.nouacer@cea.fr>], [unisim-risc16-core])" > "${RISC16_CONFIGURE_AC}"
	...
	echo "BUILT_SOURCES=\$(top_builddir)/unisim/component/cxx/processor/risc16/isa.hh \$(top_builddir)/unisim/component/cxx/processor/risc16/isa.cc" >> "${RISC16_MAKEFILE_AM}"
	echo "CLEANFILES=\$(top_builddir)/unisim/component/cxx/processor/risc16/isa.hh \$(top_buildir)/unisim/component/cxx/processor/risc16/isa.cc" >> "${RISC16_MAKEFILE_AM}"
	echo "\$(top_builddir)/unisim/component/cxx/processor/risc16/isa.cc: \$(top_builddir)/unisim/component/cxx/processor/risc16/isa.hh" >> "${RISC16_MAKEFILE_AM}"
	echo "\$(top_builddir)/unisim/component/cxx/processor/risc16/isa.hh: ${UNISIM_LIB_RISC16_ISA_FILES}" >> "${RISC16_MAKEFILE_AM}"
	printf "\t" >> "${RISC16_MAKEFILE_AM}"
	echo "\$(GENISSLIB_PATH) -o \$(top_builddir)/unisim/component/cxx/processor/risc16/isa -w 8 -I \$(top_srcdir) \$(top_srcdir)/unisim/component/cxx/processor/risc16/risc16.isa" >> "${RISC16_MAKEFILE_AM}"
