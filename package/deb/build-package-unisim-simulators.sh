...
INSTALL_PATH="usr" \
`dirname $0`/build-package.sh --host=i686-pc-linux-gnu "CXX=g++" "--with-unisim-lib=$1" "--with-systemc=$2" "CXXFLAGS=-m32 -O3 -g3 -DSC_INCLUDE_DYNAMIC_PROCESSES -DDEBUG_NETSTUB" "CPPFLAGS=-I/usr/include/libxml2" "--enable-release"
