...
INSTALL_PATH="usr" \
./build-package.sh --host=i686-pc-linux-gnu "CXX=g++" "--with-unisim-tools=$1" "--with-systemc=$2" "CXXFLAGS=-m32 -O3 -g3 -DSC_INCLUDE_DYNAMIC_PROCESSES" "CPPFLAGS=-I/usr/include/libxml2"
