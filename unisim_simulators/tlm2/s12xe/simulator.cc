	...
	if (nodejs) {
		*debugger->debug_yielding_import[front_end_num] >> nodejs->debug_yielding_export;
		...
		nodejs->debug_processors_import                 >> *debugger->debug_processors_export[front_end_num];
		{
			...
			*nodejs->registers_import[i++] >> global_flash->registers_export;
			...
			*nodejs->registers_import[i++] >> sci6->registers_export;
			*nodejs->registers_import[i++] >> sci7->registers_export;
			...
			*nodejs->registers_import[i++] >> mpu->registers_export;
			*nodejs->registers_import[i++] >> pim->registers_export;
			*nodejs->registers_import[i++] >> dbg->registers_export;
			*nodejs->registers_import[i++] >> iic0->registers_export;
			*nodejs->registers_import[i++] >> iic1->registers_export;
			*nodejs->registers_import[i++] >> vreg->registers_export;
			*nodejs->registers_import[i++] >> tim->registers_export;
			*nodejs->registers_import[i++] >> reserved->registers_export;
		}
		++front_end_num;
	}
#endif
