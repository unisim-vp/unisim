...
bool TLE72XXSL::BeginSetup() {
	...
	RegisterView<uint8_t> *spicr1_var = new RegisterView<uint8_t>("SPICR1", this, spicr1_register, "SPI Control Register 1 (SPICR1)");
	...
	RegisterView<uint8_t> *spicr2_var = new RegisterView<uint8_t>("SPICR2", this, spicr2_register, "SPI Control Register 2 (SPICR2)");
	...
	RegisterView<uint8_t> *spibr_var = new RegisterView<uint8_t>("SPIBR", this, spibr_register, "SPI Baud Rate Register (SPIBR)");
	...
	RegisterView<uint8_t> *spisr_var = new RegisterView<uint8_t>("SPISR", this, spisr_register, "SPI Status register (SPISR)");
	...
	RegisterView<uint16_t> *spidr_var = new RegisterView<uint16_t>("SPIDR", this, spidr_register, "SPI Data register (SPIDR)");
