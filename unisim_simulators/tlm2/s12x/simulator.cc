...
Simulator::Simulator(int argc, char **argv)
	...
	, param_sci_enable_telnet("sci_enable-telnet", 0, sci_enable_telnet, "Enable/Disable SCI telnet instantiation")
	, param_spi_enable_telnet("spi_enable-telnet", 0, spi_enable_telnet, "Enable/Disable SPI telnet instantiation")
