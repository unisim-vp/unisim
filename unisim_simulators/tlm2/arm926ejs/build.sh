...
python3.1 ${REPO_PATH}/package/puscomp/puscomp.py -c config.xml -o src -l -v unisim_simulator::tlm2::arm926ejs

# configure and build the simulator
cd build
cmake ../src -Dwith_osci_systemc=$SYSTEMC_PATH -Dwith_osci_tlm2=$TLM2_PATH
make -j 3
