...
namespace armsec
{
  ...
  struct FP
  {
    ...
    {
      op = FLOAT( new UONode( "FSQB", op.expr ) );
    }
    ...
    {
      op = FLOAT( new UONode( "FFZ", op.expr ) );
      return false;
    }
