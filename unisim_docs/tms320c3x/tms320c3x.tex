...
Although the integer benchmarks (written in C) have been selected to address the digital signal processing application domain, they have only validated the general operations of the simulator: basic integer computation, control flow instructions, basic addressing modes \ldots
