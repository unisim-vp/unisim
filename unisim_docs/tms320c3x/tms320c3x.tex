...
A comprehensive list of instruction level unit tests is provided in Appendix~\ref{tms320c3x_unit_tests_summary}.
...
\begin{figure}[!h]
	\begin{center}
		\begin{minipage}{\textwidth}
			\begin{minipage}{8.0cm}
				\begin{center}
					\includegraphics[width=7.0cm]{tms320c3x/fig_unit_test_generator.pdf}
					\caption{\label{fig:tms320c3x_unit_test_generator}UNISIM TMS320C3X unit test generator.}
				\end{center}
			\end{minipage}
			\begin{minipage}{8.0cm}
				\begin{center}
					\includegraphics[width=7.0cm]{tms320c3x/fig_unit_test.pdf}
...
% \begin{figure}[!h]
% 	\begin{center}
% 		\includegraphics[width=12.0cm]{tms320c3x/fig_unit_test_generator.pdf}
% 	\end{center}
% 	\caption{UNISIM TMS320C3X unit test generator.}
% 	\label{fig:tms320c3x_unit_test_generator}
% \end{figure}
...
\label{fig:tms320c3x_unit_test_float_distribution}
\end{center}
\end{figure}
...
% \begin{figure}[!h]
% 	\begin{center}
% 		\includegraphics[width=14.0cm]{tms320c3x/fig_unit_test.pdf}
% 	\end{center}
% 	\caption{A generated unit test.}
% 	\label{fig:tms320c3x_unit_test}
% \end{figure}
