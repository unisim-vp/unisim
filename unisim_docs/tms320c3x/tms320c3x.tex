...
A memory is implemented by class \texttt{unisim::component::cxx::memory::ram::Memory}.
...
\item intrusive memory access (\texttt{unisim::service::interfaces::MemoryInjection}); It can affect timing and dat placement.
\end{itemize}
