...
For instance, the following command will dump file \texttt{test.bin} into file \texttt{dump.txt}:

\begin{verbatim}
$ /opt/c4x-coff/bin/c4x-unknown-coff-objdump -D test.bin > dump.txt
\end{verbatim}
