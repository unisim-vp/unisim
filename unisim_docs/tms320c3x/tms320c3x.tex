...
The following developement board has been used to compare the simulator results against a real TMS320C3X DSP:
\begin{itemize}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=\textwidth]{tms320c3x/fig_tms320c3x_board.jpg}
	\end{center}
	\caption{TMS320VC33 Board.}
	\label{fig:tms320c3x}
\end{figure}

\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=\textwidth]{tms320c3x/fig_tms320c3x_dev_kit.jpg}
	\end{center}
	\caption{TMS320VC33 board with JTAG Emulator.}
	\label{fig:tms320c3x}
\end{figure}
