...
A comprehensive list of instruction level unit tests is provided in Appendix~\ref{tms320c3x_unit_tests_list}.

\subsubsection{Validation process}

\noindent \textbf{Unit test generator.} For the purpose of executing unit tests on both the development board and the UNISIM TMS320C3X simulator, a unit test generator has been developped, see Figure~\ref{fig:tms320c3x_unit_test_generator}.
...
The generator reads an assembly pattern and generates the unit test source code:
\begin{itemize}
...
Figure~\ref{fig:tms320c3x_assembly_pattern} shows an example of assembly pattern while Figure~\ref{fig:tms320c3x_generated_assembly} shows the core of generated assembly.
...
\texttt{~~ldiu~5,~bk~~~~~~~~~~~~~~~~~; \it ~load~block~size~(should~be~at~most~8)}\newline
\texttt{~~and~5~-~1,~r0~~~~~~~~~~~~~~; \it ~crop~random~value~between~0~and~bk~-~1}\newline
\texttt{~~ldiu~r0,~ir0~~~~~~~~~~~~~~~; \it ~load~ir0~with~this~random~value}\newline
\texttt{~~ldiu~ar2,~ar4~~~~~~~~~~~~~~; \it ~load~a~pointer~to~a~buffer~of~16~words}\newline
\texttt{~~addi~7,~ar4}\newline
\texttt{~~andn~7,~ar4~~~~~~~~~~~~~~~~; \it ~align~circular~buffer~start~on~block~size}\newline
\texttt{~~ldiu~r1,~st}\newline
\texttt{~~addf~*ar4++(ir0)\%,~r2~~~~~~; \it ~$\leftarrow$~instruction~under~test}\newline
\texttt{~~ldiu~st,~r3}\newline
\texttt{}}}\\
\end{supertabular}
\caption{\label{fig:tms320c3x_generated_assembly} Generated assembly from assembly pattern of Figure~\ref{fig:tms320c3x_assembly_pattern} and substitution strings \texttt{"5"} and \texttt{"addf"}.}
\end{center}
\end{figure}
...
\noindent \textbf{Factorial plan.} The unit test generator has been driven by a factorial plan to generate a sufficient number of instruction alternatives.\\
\noindent The conditional instructions have 20 possibles conditions:\\
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{lde dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{ldf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{ldf\textit{cond} dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{ldi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{ldi\textit{cond} dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{ldm dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{stf reg, dir}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{sti reg, dir}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{absf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{absi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{addc dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{addf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{addi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{and dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{andn dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{ash dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{cmpf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{cmpi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{fix dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{float dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{lsh dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{mpyf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{mpyi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{negb dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{negf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{negi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{norm dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{not dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{or dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{rnd dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subb dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subc dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subi dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subrb dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subrf dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{subri dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{tstb dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{xor dir, reg}} & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{7.0cm}|}{}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{mpyi3 reg, indir, reg || addi3 indir, reg, reg}} & \multicolumn{1}{p{1.0cm}|}{?} & \multicolumn{1}{p{7.0cm}|}{?}\\
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{mpyi3 reg, indir, reg || addi3 reg, indir, reg}} & \multicolumn{1}{p{1.0cm}|}{?} & \multicolumn{1}{p{7.0cm}|}{?}\\
\hline
...
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{mpyi3 reg, indir, reg || subi3 indir, reg, reg}} & \multicolumn{1}{p{1.0cm}|}{?} & \multicolumn{1}{p{7.0cm}|}{?}\\
\hline
\multicolumn{1}{|p{7.0cm}|}{\scriptsize \texttt{mpyi3 reg, indir, reg || subi3 reg, indir, reg}} & \multicolumn{1}{p{1.0cm}|}{?} & \multicolumn{1}{p{7.0cm}|}{?}\\
\hline
...
\item \texttt{doc}: generate unit tests latex documentation (test.tex). This feature has been used to generate the comprehensive list of unit tests from Appendix~\ref{tms320c3x_unit_tests_list}
\item \texttt{clean}: clean everything
\item \texttt{cleangen}: clean generator executable (generator)
...
\subsubsection{Running unit tests on the development board}
...
\textit{Note: Code Composer may complain in a dialog box that it can't communicate with the board through a USB port, see Figure~\ref{fig:tms320c3x_driver_error}. Disconnect and reconnect the USB cable on the JTAG emulator, and then click button "Retry" to resume execution.}
...
% \begin{figure}[!h]
% 	\begin{center}
% 		\includegraphics[width=10.0cm]{tms320c3x/fig_code_composer.jpg}
% 		\caption{\label{fig:tms320c3x_cc} GNU Make (on the left) launching unit tests on the development board using code composer (on the right)}
% 	\end{center}
% \end{figure}
% 
% \begin{figure}[!h]
% 	\begin{center}
% 		\includegraphics[width=8.0cm]{tms320c3x/fig_driver_error.jpg}
% 		\caption{\label{fig:tms320c3x_driver_error} VC33 device driver communication problem.}
% 	\end{center}
% \end{figure}

\subsubsection{Using the testing environment as a non-regression test}

The testing environment also acts as a non-regression test for UNISIM TMS320C3X simulator as the expected results (\texttt{output.ref}) are already provided in the testing environment.
To check that all unit tests successfully run on the UNISIM TMS320C3X simulator, do the following at the command prompt:
\begin{verbatim}
$ make generator cleancheck cleansim
$ make check SIMULATE=tms320c3x
\end{verbatim}
