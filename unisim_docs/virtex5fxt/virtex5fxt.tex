...
\begin{script}
$ make CROSS_COMPILE=/opt/crosstool/gcc-4.4.6-glibc-2.9/powerpc-440fp-linux-gnu/bin/powerpc-440fp-linux-gnu-
\end{script}

\subsubsection{Building the MiBench version 1 benchmarks}
