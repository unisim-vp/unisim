...
%		\draw[help lines] (0,0) grid (15,10);
		...
		\path (5,2.8) coordinate (unknown_ns);
		...
		\draw (time) node[above] {\small \textbf{\textsf{Local time}}};
		}
		\onslide*<2-> {
		...
		\draw (call_right) node[above left] {\texttt{\textbf{TRANS}}};
		}
		\onslide*<3-> {
		...
		\draw (unknown_ns) node[below] {\small \textbf{\textsf{(unknown time)}}};
		}
	\end{tikzpicture}
\end{figure}
\end{frame}
...
%		\draw[help lines] (0,0) grid (15,10);
		...
		\path (6,0.5) node(110ns) [rectangle,draw,fill=blue!20] {\footnotesize \textsf{\textbf{Simulation time = 110ns}}};
		\path (ret_left) +(-2,0) coordinate (control_ret_left);
...
\begin{frame}
	\frametitle{Loosely-timed with temporal decoupling and synchronization-on-demand}
...
\begin{frame}
	\frametitle{Loosely-timed with temporal decoupling and quantum}
...
%		\draw[help lines] (0,0) grid (15,10);
		...
		\path (6,0.3) node(110ns) [rectangle,draw,fill=blue!20] {\footnotesize \textsf{\textbf{Simulation time = 6us}}};
...
\subsection{Approximately-timed with polling}

\mode<presentation>{

\begin{frame}
	\frametitle{Approximately-timed with polling}
...
%		\draw[help lines] (0,0) grid (15,20);
		...
		\path (6,18.5) coordinate (100ns);
		\path (7,17.5) coordinate (breq0_call_l);
		\path (14,17.5) coordinate (breq0_call_r);
		\path (7,17.3) coordinate (breq0_ret_l);
		\path (14,17.3) coordinate (breq0_ret_r);

		\path (6,16.5) coordinate (110ns);
		\path (7,15.5) coordinate (breq1_call_l);
		\path (14,15.5) coordinate (breq1_call_r);
		\path (7, 15.3) coordinate (breq1_ret_l);
		\path (14,15.3) coordinate (breq1_ret_r);

		\path (6,14.5) coordinate (120ns);
		\path (2,13.5) coordinate (breq_l);
		\path (4,13.5) coordinate (breq_r);
		\path (7,13.5) coordinate (breq_call_l);
		\path (14,13.5) coordinate (breq_call_r);
		\path (7,13.3) coordinate (breq_ret_l);
		\path (14,13.3) coordinate (breq_ret_r);

		\path (6,12.5) coordinate (130ns);
		\path (2,11.5) coordinate (ereq_l);
		\path (4,11.5) coordinate (ereq_r);
		\path (7,11.5) coordinate (ereq_call_l);
		\path (14,11.5) coordinate (ereq_call_r);
		\path (7,11.3) coordinate (ereq_ret_l);
		\path (14,11.3) coordinate (ereq_ret_r);
		...
		\draw (100ns) node [rectangle,draw,fill=blue!20] {\footnotesize \textsf{\textbf{Simulation time = 100ns}}};
		\draw[thick,-latex] (breq0_call_l) -- (breq0_call_r);
		\draw (breq0_call_l) node[above right] {\footnotesize \emph{Call}};
		\draw (breq0_call_r) node[above left] {\small \texttt{\textbf{-, BEGIN\_REQ, 0ns}}};
		\draw[thick,latex-] (breq0_ret_l) -- (breq0_ret_r);
		\draw (breq0_ret_l) node[below right] {\footnotesize \emph{Return}};
		\draw (breq0_ret_r) node[below left] {\small \texttt{\textbf{TLM\_REJECTED, -, -}}};

		\draw (110ns) node [rectangle,draw,fill=blue!20] {\footnotesize \textsf{\textbf{Simulation time = 110ns}}};
		\draw[thick,-latex] (breq1_call_l) -- (breq1_call_r);
		\draw (breq1_call_l) node[above right] {\footnotesize \emph{Call}};
		\draw (breq1_call_r) node[above left] {\small \texttt{\textbf{-, BEGIN\_REQ, 0ns}}};
		\draw[thick,latex-] (breq1_ret_l) -- (breq1_ret_r);
		\draw (breq1_ret_l) node[below right] {\footnotesize \emph{Return}};
		\draw (breq1_ret_r) node[below left] {\small \texttt{\textbf{TLM\_REJECTED, -, -}}};
		...
		\draw (ereq_l) node[below right] {\small \textsf{END\_REQ}} -- (ereq_r);
		\draw[thick,latex-] (ereq_call_l) -- (ereq_call_r);
		\draw (eresp_call_r) node[above left] {\footnotesize \emph{Call}};
		\draw (eresp_call_l) node[above right] {\small \texttt{\textbf{-, END\_REQ, 0ns}}};
		\draw[thick,-latex] (ereq_ret_l) -- (ereq_ret_r);
		\draw (ereq_ret_r) node[below left] {\footnotesize \emph{Return}};
		\draw (ereq_ret_l) node[below right] {\small \texttt{\textbf{TLM\_ACCEPTED, -, -}}};
...
\mode<article>{
Figure~\ref{fig:chart_at_with_polling} shows the message exchange that occur when using the approximately-timed coding style with polling.
...
%		\draw[help lines] (0,0) grid (15,20);
	...
	\end{tikzpicture}
	\end{center}
	\caption{Approximately-timed coding style with polling message chart.}
	\label{fig:chart_at_with_polling}
\end{figure}
}
