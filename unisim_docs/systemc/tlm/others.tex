...
Also the TLM 2.0 user manual explicitly states that the other capabilities like the atomic transactions might appear in future revisions of the OSCI TLM.
