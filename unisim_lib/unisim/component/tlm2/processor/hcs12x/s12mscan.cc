...
void S12MSCAN::TelnetProcessInput()
{
...
inline uint16_t S12MSCAN::buildFrame(uint8_t high, uint8_t low, SCIMSG msgType) {
...
//inline void S12MSCAN::txShiftOut(SCIMSG msgType, uint8_t length)
inline void S12MSCAN::txShiftOut(SCIMSG msgType)
{
