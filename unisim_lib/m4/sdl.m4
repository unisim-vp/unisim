...
AC_DEFUN([UNISIM_CHECK_SDL], [
    ...
    UNISIM_CHECK_LIB(SDL, SDL_WaitThread, $1,
    UNISIM_CHECK_LIB(SDL, SDL_FreeSurface, $1,
    UNISIM_CHECK_LIB(SDL, SDL_DestroyMutex, $1,
    UNISIM_CHECK_LIB(SDL, SDL_Quit, $1,
    UNISIM_CHECK_LIB(SDL, SDL_Init, $1,
    UNISIM_CHECK_LIB(SDL, SDL_CreateMutex, $1,
    UNISIM_CHECK_LIB(SDL, SDL_CreateThread, $1,
    UNISIM_CHECK_LIB(SDL, SDL_mutexP, $1,
    UNISIM_CHECK_LIB(SDL, SDL_mutexV, $1,
    UNISIM_CHECK_LIB(SDL, SDL_GetKeyName, $1,
    UNISIM_CHECK_LIB(SDL, SDL_Delay, $1,
    UNISIM_CHECK_LIB(SDL, SDL_PollEvent, $1,
    UNISIM_CHECK_LIB(SDL, SDL_SetVideoMode, $1,
    UNISIM_CHECK_LIB(SDL, SDL_WM_SetCaption, $1,
    UNISIM_CHECK_LIB(SDL, SDL_CreateRGBSurface, $1,
    UNISIM_CHECK_LIB(SDL, SDL_LockSurface, $1,
    UNISIM_CHECK_LIB(SDL, SDL_UnlockSurface, $1,
    UNISIM_CHECK_LIB(SDL, SDL_UpperBlit, $1,
    UNISIM_CHECK_LIB(SDL, SDL_UpdateRect, $1,
    UNISIM_CHECK_LIB(SDL, SDL_SaveBMP_RW, $1, broken_sdl=no,
    broken_sdl=yes),
    broken_sdl=yes),
    broken_sdl=yes),
    broken_sdl=yes),
