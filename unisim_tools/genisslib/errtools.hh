...
struct FileLoc
{
  FileLoc() : m_line( 0 ), m_column( 0 ) {}
  FileLoc( ConstStr _name, intptr_t _line, intptr_t _column )
    : m_name( _name ), m_line( _line ), m_column( _column )
  {}
  FileLoc( FileLoc const& _fl )
    : m_name( _fl.m_name ), m_line( _fl.m_line ), m_column( _fl.m_column )
  {}
  
  FileLoc& operator=( FileLoc const& _fl )
  { m_name = _fl.m_name; m_line = _fl.m_line; m_column = _fl.m_column; return *this; }
  FileLoc& assign( ConstStr _name, intptr_t _line, intptr_t _nxtcol )
  { m_name = _name; m_line = _line; m_column = _nxtcol; return *this; }
