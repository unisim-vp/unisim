## UNISIM_CHECK_HEADERS
## Checks if some headers can be found
## Takes the name of the header (i.e., inttypes.h, vector,...)
#####################################################
AC_DEFUN([UNISIM_CHECK_HEADERS], [
	AC_CHECK_HEADERS([$1],,\
    	AC_MSG_ERROR([C/C++ $1 header is missing in your system.]))
])
